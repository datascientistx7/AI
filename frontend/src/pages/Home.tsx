...
import { Brain, Database, Network, Sparkles, Flame, MoveRight, Play } from 'lucide-react';
      ...
      <section className="space-y-6">
        ...
        <div className="glass-card hover:border-primary/30 transition-all p-8 flex justify-between items-center group cursor-pointer relative overflow-hidden">
          ...
          <div className="flex items-center space-x-6 z-10">
            ...
            <div>
              <p className="text-sm text-primary font-bold uppercase tracking-wider mb-1">Machine Learning</p>
              <h3 className="text-2xl font-display font-bold text-white mb-2">Overfitting vs Underfitting</h3>
                  ...
                  <div className="glass-card glass-card-hover h-full p-6 flex flex-col items-start relative group">
                    ...
                    <div className="w-full relative z-10 mt-auto">
                      <div className="flex justify-between text-xs mb-2">
                        ...
                        <span className="font-medium text-white">{mod.progress}%</span>
                      </div>
                      <div className="w-full bg-background rounded-full h-1.5 overflow-hidden">
                        <div className="h-full rounded-full transition-all duration-1000 ease-out" style={{ width: `${mod.progress}%`, backgroundColor: mod.color }} />
                      </div>
                    </div>
                  </div>
                </Link>
